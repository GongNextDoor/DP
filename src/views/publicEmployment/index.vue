        ...
        <div class="ct-right-bottom">
          <div class="top">
            <BoxItem title="享受政策服务情况">
              <div class="info">
                <div class="peopole">
                  累计补贴人次数：<span>{{ num6 }}</span>人
                </div>
                <div class="currcy">
                  累计补贴金额：<span>{{ num7 }}</span>万元
                </div>
              </div>
...
export default {
  ...
  methods: {
    select1(index) {
      ...
      if (index === 0) {
        this.pieData = [{ name: '单位就业', value: '336484' }, { name: '灵活就业', value: '2941871' }, { name: '自主创业', value: '132409' }]
      } else if (index === 1) {
        this.pieData = [{ name: '6个月以下', value: '922586' }, { name: '一年以下', value: '128674' }, { name: '一年至两年', value: '311803' }, { name: '两年至三年', value: '346178' }, { name: '三年以上', value: '2395045' }]
      } else if (index === 2) {
        this.pieData = [{ name: '16-30岁', value: '421304' }, { name: '31-40岁', value: '809635' }, { name: '41-50岁', value: '1099067' }, { name: '51-60岁', value: '1080758' }]
      } else if (index === 3) {
        this.pieData = [{ name: '小学', value: '91319' }, { name: '初中', value: '588499' }, { name: '高中', value: '670453' }, { name: '大专及以上', value: '223270' }, { name: '其他', value: '1837223' }]
      }
    },
    select2(index) {
      ...
      if (index === 0) {
        this.name1 = '失业周期'
        this.pieData1 = [{ name: '6个月以下', value: '922586' }, { name: '一年以下', value: '128674' }, { name: '一年至两年', value: '311803' }, { name: '两年至三年', value: '346178' }, { name: '三年以上', value: '2395045' }]
      } else if (index === 1) {
        this.name1 = '年龄结构\n\n分析'
        this.pieData1 = [{ name: '16-30岁', value: '82019' }, { name: '31-40岁', value: '111551' }, { name: '41-50岁', value: '71071' }, { name: '51-60岁', value: '8634' }]
      } else if (index === 2) {
        this.name1 = '文化程度\n\n分析'
        this.pieData1 = [{ name: '小学', value: '85492' }, { name: '初中', value: '111698' }, { name: '高中', value: '50280' }, { name: '大专及以上', value: '58316' }, { name: '其他', value: '341076' }]
      }
    },
    init(name) {
      this.detail(name)
    ...
    detail(name) {
      if (name === '长沙市') {
        ...
        this.num4 = 201050
        this.num5 = 270
        this.pieData = [{ name: '单位就业', value: '49613' }, { name: '灵活就业', value: '745306' }, { name: '自主创业', value: '10266' }]
        this.pieData1 = [{ name: '6个月以下', value: '15617' }, { name: '一年以下', value: '15572' }, { name: '一年至两年', value: '6169' }, { name: '两年至三年', value: '11880' }, { name: '三年以上', value: '12980' }]
        this.lineData.yData = ['2.6', '2.87', '3.24', '0']
        ...
        this.num4 = 35292
        this.num5 = 2301
        this.pieData = [{ name: '单位就业', value: '5370' }, { name: '灵活就业', value: '72069' }, { name: '自主创业', value: '5467' }]
        this.pieData1 = [{ name: '6个月以下', value: '2332' }, { name: '一年以下', value: '2441' }, { name: '一年至两年', value: '1321' }, { name: '两年至三年', value: '5523' }, { name: '三年以上', value: '2033' }]
        this.lineData.yData = ['2.58', '2.68', '2.88', '0']
        this.barData1.yData = ['16492', '50370', '20261']
        this.barData.yData1 = ['899', '0', '724', '0', '2421', '6698', '3019', '2394']
        ...
        this.barData.yData1 = ['61549', '32682', '66603', '16736', '547908', '129135', '47673', '234052']
